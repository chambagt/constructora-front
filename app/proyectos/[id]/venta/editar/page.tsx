...
export default function EditarRFVentaPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && proyectoId) {
      ...
      const resumenEncontrado = resumenesGuardados.find(
        (r: ResumenFinanciero) => r.proyectoId === proyectoId && r.tipo === "venta",
      )
  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex items-center mb-6">
        <Button variant="outline" onClick={() => router.push(`/proyectos/${proyectoId}/venta`)} className="mr-4">
          <ArrowLeft className="h-4 w-4 mr-2" />
          Volver al RF
        </Button>
        <div>
          <h1 className="text-2xl font-bold">Editar Resumen Financiero - Venta</h1>
